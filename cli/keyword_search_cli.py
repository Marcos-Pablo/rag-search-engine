...
def main() -> None:
    ...
    term_frequency_parser.add_argument(
        "term", type=str, help="Term to get the frequency for"
    )

    idf_parser = subparsers.add_parser(
        "idf", help="Get the inverse document frequency for a given term"
    )
    idf_parser.add_argument("term", type=str, help="Term to get IDF for")

    tfidf_parser = subparsers.add_parser(
        "tfidf", help="Get the TF-IDF for a given document ID and term"
    )
    ...
    match args.command:
        ...
        case "tfidf":
            print(f"Getting the TF-IDF of {args.term}")
        ...
        case "bm25tf":
            print(f"Getting the BM25 TF score of '{args.term}'")
        ...
        case "bm25idf":
            print(f"Getting the BM25 IDF score of '{args.term}'")
