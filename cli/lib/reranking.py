...
def cross_enconder_rerank(query: str, docs: list[dict], limit: int = 5):
    pairs = []
    for doc in docs:
    ...
    for i, doc in enumerate(docs):
        reranked.append({**doc, "cross_encoder_score": scores[i]})
...
def rerank(
    ...
    match method:
        ...
        case "cross_encoder":
            return cross_enconder_rerank(query, docs, limit)
        case _:
            return docs[:limit]
